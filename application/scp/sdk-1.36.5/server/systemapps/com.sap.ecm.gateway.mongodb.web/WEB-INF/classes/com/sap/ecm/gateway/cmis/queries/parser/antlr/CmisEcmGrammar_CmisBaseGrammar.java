// $ANTLR 3.5.2 CmisBaseGrammar.g 2018-09-13 08:43:34
...
public class CmisEcmGrammar_CmisBaseGrammar extends Parser {
	...
	public final CmisEcmGrammar_CmisBaseGrammar.multi_valued_column_reference_return multi_valued_column_reference() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: qualifier, multi_valued_column_name
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt14) {
				...
				case 3 :
					...
					// AST REWRITE
					// elements: table_name, correlation_name
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt23) {
				case 1 :
					...
					// AST REWRITE
					// elements: literal, EQ, column_reference
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: literal, NEQ, column_reference
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 3 :
					...
					// AST REWRITE
					// elements: LT, literal, column_reference
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 4 :
					...
					// AST REWRITE
					// elements: column_reference, GT, literal
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 5 :
					...
					// AST REWRITE
					// elements: column_reference, LTEQ, literal
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 6 :
					...
					// AST REWRITE
					// elements: literal, GTEQ, column_reference
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt24) {
				...
				case 2 :
					...
					// AST REWRITE
					// elements: column_reference, in_value_list
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt26) {
				case 1 :
					...
					// AST REWRITE
					// elements: LIKE, column_reference, STRING_LIT
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final CmisEcmGrammar_CmisBaseGrammar.text_search_predicate_return text_search_predicate() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: CONTAINS, text_search_expression, qualifier
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final CmisEcmGrammar_CmisBaseGrammar.folder_predicate_return folder_predicate() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: qualifier, folder_id, f
			// token labels: f
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
